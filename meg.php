...
function meg_Validate($hash_id) {
    $url = MEG_BASEURL . '/builder/program-validate/%s';
    $request = new WP_Http;
    $payload = array(
        'url' => site_url()
    );
...
echo <<<END
    ...
    To find your MEG ID, log into the <a target="_blank" href="http://apps.meg.com">MEG Manager</a> and select Channel Management from the menu at the top right.</p>
    <p>Questions?<br/>
